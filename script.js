...
let height = parseInt(prompt("Introduzca el alto del tablero entre 1 y 5")); //pixels alto
let width = parseInt(prompt("Introduzca el ancho del tablero 1 y 5")); //pixels ancho
